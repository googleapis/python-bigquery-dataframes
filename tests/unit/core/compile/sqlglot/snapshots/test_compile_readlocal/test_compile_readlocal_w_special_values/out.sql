SELECT `col_none`, `col_inf`, `col_neginf`, `col_nan`, `col_struct_none`, `col_struct_w_none`, `col_list_none` FROM (SELECT
  ...
  `t0`.`bfuid_col_1683` AS `bfuid_col_1684`
FROM (
  SELECT
    *
  FROM UNNEST(ARRAY<STRUCT<`column_0` FLOAT64, `column_1` FLOAT64, `column_2` FLOAT64, `column_3` FLOAT64, `column_4` STRUCT<foo INT64>, `column_5` STRUCT<foo INT64>, `column_6` ARRAY<INT64>, `bfuid_col_1683` INT64>>[STRUCT(
...
ORDER BY `bfuid_col_1684` ASC NULLS LAST