WITH `bfcte_0` AS (
  ...
  FROM `bigframes-dev-perf`.`tpch_0001t`.`PART` AS `bft_4` FOR SYSTEM_TIME AS OF '2026-03-30T18:00:00'
  WHERE
  ...
  FROM `bigframes-dev-perf`.`tpch_0001t`.`PARTSUPP` AS `bft_3` FOR SYSTEM_TIME AS OF '2026-03-30T18:00:00'
), `bfcte_2` AS (
  SELECT
    `L_PARTKEY`,
    `L_SUPPKEY`,
  ...
  FROM `bigframes-dev-perf`.`tpch_0001t`.`NATION` AS `bft_1` FOR SYSTEM_TIME AS OF '2026-03-30T18:00:00'
  WHERE
    `N_NAME` = 'CANADA'
), `bfcte_4` AS (
  SELECT
  ...
  FROM `bigframes-dev-perf`.`tpch_0001t`.`SUPPLIER` AS `bft_0` FOR SYSTEM_TIME AS OF '2026-03-30T18:00:00'
), `bfcte_5` AS (
  SELECT
    `bfcol_15`
  FROM `bfcte_0`
