...
import bigframes.functions.function_template as function_template
...
def test_convert_from_bq_json(type_, json_value, expected):
    got = function_template.convert_from_bq_json(type_, json_value)
    assert got == expected
...
def test_convert_from_bq_json_none(type_):
    got = function_template.convert_from_bq_json(type_, None)
    assert got is None
...
def test_convert_to_bq_json(type_, value, expected):
    got = function_template.convert_to_bq_json(type_, value)
    assert got == expected
...
def test_convert_to_bq_json_none(type_):
    got = function_template.convert_to_bq_json(type_, None)
    assert got is None
...
def test_get_pd_series(row_json, expected):
    got = function_template.get_pd_series(row_json)
