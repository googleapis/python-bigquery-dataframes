...
def test_concat_dataframe_w_struct_cols(nested_structs_df, nested_struct_pandas_df):
    ...
    pd_result = pd.concat((pd.DataFrame(), nested_struct_pandas_df), ignore_index=True)
