...
def test_insert(scalars_dfs, loc, column, value, allow_duplicates):
    ...
    assert_frame_equal(bf_df.to_pandas(), pd_df, check_dtype=False)
...
def test_df_memory_usage(scalars_dfs):
    ...
    assert_series_equal(pd_result, bf_result, rtol=1.5)
...
def test_setitem_multicolumn_with_literals(scalars_dfs, key, value):
    ...
    assert_frame_equal(pd_result, bf_result.to_pandas(), check_dtype=False)
...
def test_df_replace_scalar_scalar(scalars_dfs):
    ...
    assert_frame_equal(pd_result, bf_result, check_dtype=False)
...
def test_df_update(overwrite, filter_func):
    ...
    assert_frame_equal(bf_df1.to_pandas(), pd_df1)
...
def test_df_idxmin():
    ...
    assert_series_equal(bf_result, pd_result, check_index_type=False, check_dtype=False)
...
def test_df_align(join, axis):
    ...
    assert_frame_equal(bf_result1.to_pandas(), pd_result1, check_dtype=False)
    assert_frame_equal(bf_result2.to_pandas(), pd_result2, check_dtype=False)
...
def test_dataframe_numeric_analytic_op(
    ...
    assert_frame_equal(pd_series, bf_result, check_dtype=False)
...
def test_df_melt_parameterized(scalars_dfs):
    ...
    # Pandas produces int64 index, Bigframes produces Int64 (nullable)
    assert_frame_equal(bf_result, pd_result, check_index_type=False, check_dtype=False)
...
def test_df_pivot_table(
    ...
    assert_frame_equal(bf_result, pd_result, check_dtype=False, check_column_type=False)
...
def test_dataframe_bool_aggregates(scalars_df_index, scalars_pandas_df_index, op):
    ...
    assert_series_equal(pd_series, bf_result, check_index_type=False)
