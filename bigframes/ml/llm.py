...
class GeminiTextGenerator(base.BaseEstimator):
    ...
    def fit(
        ...
        """Fine tune GeminiTextGenerator model. Only support "gemini-pro" and "gemini-1.5" model for now.
    ...
    def score(
        ...
        """Calculate evaluation metrics of the model. Only "gemini-pro" and "gemini-1.5" model is supported for now.
