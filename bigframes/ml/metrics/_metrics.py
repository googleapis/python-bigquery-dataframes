...
def r2_score(
    ...
    *,
    ...
    y_true_series, y_pred_series = utils.batch_to_series(y_true, y_pred)
...
def roc_curve(
    ...
    *,
    ...
    y_true_series, y_score_series = utils.batch_to_series(y_true, y_score)
...
def auc(
    ...
    x_series, y_series = utils.batch_to_series(x, y)
