...
class BlobAccessor(base.SeriesMethods):
    ...
    def pdf_extract(
        ...
        *,
        ...
        Args:
            ...
            verbose (bool, default "True"): controls the verbosity of the output.
        ...
        content_series = bbq.json_extract(res, "$.content")
        if verbose:
    ...
    def pdf_chunk(
        ...
        *,
        ...
        Returns:
            bigframe.series.Series: Series of array[str] | str,
