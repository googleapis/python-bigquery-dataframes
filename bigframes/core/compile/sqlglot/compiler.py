...
@_compile_node.register
def compile_cte_ref_node(node: nodes.CteRefNode, child: ir.SQLGlotIR):
    return ir.SQLGlotIR.from_cte_ref(
...
@_compile_node.register
def compile_cte_node(node: nodes.CteNode, child: ir.SQLGlotIR):
