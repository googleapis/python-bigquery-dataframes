...
def date_add_op_impl(x: ibis_types.TimestampValue, y: ibis_types.IntegerValue):
    return x + (y // UNIT_TO_US_CONVERSION_FACTORS["d"]).to_interval("day")


@scalar_op_compiler.register_binary_op(ops.date_sub_op)
def date_sub_op_impl(x: ibis_types.TimestampValue, y: ibis_types.IntegerValue):
    return x - (y // UNIT_TO_US_CONVERSION_FACTORS["d"]).to_interval("day")
