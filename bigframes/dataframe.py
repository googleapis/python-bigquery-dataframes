    ...
    def corrwith(
        ...
        *,
        ...
        block, _ = block.aggregate(
            aggregations=tuple(
                expression_types.BinaryAggregation(agg_ops.CorrOp(), left_ex, right_ex)
        ...
        if utils.is_dict_like(func):
            ...
            for col_label, agg_func in func.items():
                ...
                for agg_func in agg_func_list:
                    ...
                    agg_expr = (
                        expression_types.UnaryAggregation(agg_op, ex.deref(col_id))
                        if isinstance(agg_op, agg_ops.UnaryAggregateOp)
                        else expression_types.NullaryAggregation(agg_op)
                    )
