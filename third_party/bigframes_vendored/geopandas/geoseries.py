    ...
    **Examples:**
    ...
    def difference(self) -> bigframes.series.Series:
        ...
        **Examples:**
        ...
        We can also check two GeoSeries against each other, row by row. The
        GeoSeries above have different indices. We can either align both GeoSeries
        ...
        order using align=False:
            ...
            0      POLYGON ((0.99954 1, 2 2, 0 2, 0 1, 0.99954 1))
            1    POLYGON ((0 0, 1 1.00046, 2 2, 1 2.0003, 0 2, ...
            2                     LINESTRING (0 0, 1 1.00046, 2 2)
            3                                LINESTRING (2 0, 0 2)
