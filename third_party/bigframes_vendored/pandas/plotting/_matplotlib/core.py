# Contains code from https://github.com/pandas-dev/pandas/blob/v2.1.3/pandas/plotting/_matplotlib/core.py
...
import numpy as np
from pandas._typing import IndexLabel, PlottingOrientation
