# Original: https://github.com/googleapis/python-bigquery/blob/main/tests/unit/test__pyarrow_helpers.py
...
def module_under_test():
    from third_party.bigframes_vendored.google_cloud_bigquery import _pyarrow_helpers
