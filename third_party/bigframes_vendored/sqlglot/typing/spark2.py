...
from bigframes_vendored.sqlglot.helper import ensure_list
from bigframes_vendored.sqlglot.typing.hive import (
    EXPRESSION_METADATA as HIVE_EXPRESSION_METADATA,
)
