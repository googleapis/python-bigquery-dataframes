# Contains code from https://github.com/tobymao/sqlglot/blob/v28.5.0/sqlglot/executor/table.py
...
from bigframes_vendored.sqlglot.helper import dict_depth
from bigframes_vendored.sqlglot.schema import AbstractMappingSchema, normalize_name
