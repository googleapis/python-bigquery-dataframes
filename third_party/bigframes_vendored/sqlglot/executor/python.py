# Contains code from https://github.com/tobymao/sqlglot/blob/v28.5.0/sqlglot/executor/python.py

import collections
import itertools
import math

from bigframes_vendored.sqlglot import exp, generator, planner, tokens
from bigframes_vendored.sqlglot.dialects.dialect import Dialect, inline_array_sql
from bigframes_vendored.sqlglot.errors import ExecuteError
from bigframes_vendored.sqlglot.executor.context import Context
from bigframes_vendored.sqlglot.executor.env import ENV
from bigframes_vendored.sqlglot.executor.table import RowReader, Table
