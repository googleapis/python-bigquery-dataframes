...
from bigframes_vendored.sqlglot.executor.python import PythonExecutor
from bigframes_vendored.sqlglot.optimizer import optimize
from bigframes_vendored.sqlglot.optimizer.annotate_types import annotate_types
from bigframes_vendored.sqlglot.planner import Plan
from bigframes_vendored.sqlglot.schema import (
    ensure_schema,
    flatten_schema,
    nested_get,
    nested_set,
)
from bigframes_vendored.sqlglotes_vendored.sqlglot.executor.table import (
    ensure_tables,
    Table,
)
from bigframes_vendored.sqlglotes_vendored.sqlglot.helper import dict_depth
    ...
    if not schema:
        ...
        for keys in flattened_tables:
            ...
            for column in table.columns:
                ...
                column_type = (
                    annotate_types(exp.convert(value), dialect=dialect).type
